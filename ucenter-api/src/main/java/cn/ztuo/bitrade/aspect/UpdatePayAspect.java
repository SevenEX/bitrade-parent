...
public class UpdatePayAspect {
    ...
    @Pointcut("execution(public * cn.ztuo.bitrade.controller.ApproveController.updateAli(..))"+
            "||execution(public * cn.ztuo.bitrade.controller.ApproveController.updateBank(..))"+
            "||execution(public * cn.ztuo.bitrade.controller.ApproveController.updateWechat(..))"+
            "||execution(public * cn.ztuo.bitrade.controller.ApproveController.deleteBind(..))")
