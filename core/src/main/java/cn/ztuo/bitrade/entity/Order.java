...
public class Order {
    ...
    @Excel(name = "付款参考号", orderNum = "1", width = 20)
    @Column(columnDefinition = "varchar(16) default '' comment '付款参考号'")
    ...
    @NotNull(message = "{ADVERTISE.TYPE.NULL}")
    ...
    @Column(columnDefinition = "decimal(20,8) comment '价格'")
    ...
    @Column(columnDefinition = "decimal(20,8) comment '最高交易额'")
    private BigDecimal maxLimit;

    /**
     * 国家
     */
    @NotBlank(message = "{Order.country.blank}")
    ...
    @Column(columnDefinition = "decimal(20,8) comment '最低交易额'")
    ...
    @Column(columnDefinition = "decimal(20,8) comment '交易金额'")
    private BigDecimal money;

    /**
     * 交易数量
     */
    @Column(columnDefinition = "decimal(20,8) comment '交易数量'")
     ...
     * 手续费
     */
    @Column(columnDefinition = "decimal(20,8) comment '手续费'")
     ...
     * 付费方式(用英文逗号隔开)
     */
    @NotBlank(message = "Order.payMode.blank")
